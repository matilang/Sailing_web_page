...
export const instructorsData = [
    ...
    { name: 'Szymon Swosiński', imageSrc: anon, link: 'strona_szym'},
  ];

export const racingTeamData = [
    { name: 'Jakub Pankowski', imageSrc: anon, link: '/https://pg.edu.pl/p/jakub-pankowski-3610' },
  ];